...
export declare class Eth {
  ...
  public defaultBlock: BlockType;
  public BatchRequest: new () => BatchRequest;
  public Iban: new (address: string) => Iban;
  public Contract: new (jsonInterface: any[], address?: string, options?: {
    from?: string
  ...
  public call(callObject: Tx, defaultBloc?: BlockType, callBack?: Callback<string>): Promise<string>;
  public clearSubscriptions(): boolean;
  public subscribe(type: 'logs', options?: Logs, callback?: Callback<Subscribe<Log>>): Promise<Subscribe<Log>>;
  public subscribe(type: 'syncing', callback?: Callback<Subscribe<any>>): Promise<Subscribe<any>>;
  public subscribe(type: 'newBlockHeaders', callback?: Callback<Subscribe<BlockHeader>>): Promise<Subscribe<BlockHeader>>;
  public subscribe(type: 'pendingTransactions', callback?: Callback<Subscribe<Transaction>>): Promise<Subscribe<Transaction>>;
  public subscribe(type: 'pendingTransactions' | 'newBlockHeaders' | 'syncing' | 'logs', options?: Logs, callback?: Callback<Subscribe<Transaction | BlockHeader | any>>): Promise<Subscribe<Transaction | BlockHeader | any>>;

  public unsubscribe(callBack: Callback<boolean>): void | boolean;
  public compile: {
  ...
  public estimateGas(tx: Tx, callback?: Callback<number>): Promise<number>;
  public getAccounts(cb?: Callback<string[]>): Promise<string[]>;
  public getBalance(address: string, defaultBlock?: BlockType, cb?: Callback<number>): Promise<number>;
  public getBlock(number: BlockType, returnTransactionObjects?: boolean, cb?: Callback<Block>): Promise<Block>;
  public getBlockNumber(callback?: Callback<number>): Promise<number>;
  public getBlockTransactionCount(number: BlockType | string, cb?: Callback<number>): Promise<number>;
  public getBlockUncleCount(number: BlockType | string, cb?: Callback<number>): Promise<number>;
  public getCode(address: string, defaultBlock?: BlockType, cb?: Callback<string>): Promise<string>;
  public getCoinbase(cb?: Callback<string>): Promise<string>;
  public getCompilers(cb?: Callback<string[]>): Promise<string[]>;
  public getGasPrice(cb?: Callback<number>): Promise<number>;
  public getHashrate(cb?: Callback<number>): Promise<number>;
  public getPastLogs(options: {
    fromBlock?: BlockType
    toBlock?: BlockType
    address: string
    topics?: Array<string | string[]>,
  },                 cb?: Callback<Log[]>): Promise<Log[]>;
  public getProtocolVersion(cb?: Callback<string>): Promise<string>;
  public getStorageAt(address: string, defaultBlock?: BlockType, cb?: Callback<string>): Promise<string>;
  public getTransactionReceipt(hash: string, cb?: Callback<TransactionReceipt>): Promise<TransactionReceipt>;
  public getTransaction(hash: string, cb?: Callback<Transaction>): Promise<Transaction>;
  public getTransactionCount(address: string, defaultBlock?: BlockType, cb?: Callback<number>): Promise<number>;
  public getTransactionFromBlock(block: BlockType, index: number, cb?: Callback<Transaction>): Promise<Transaction>;
  public getUncle(blockHashOrBlockNumber: BlockType | string, uncleIndex: number, returnTransactionObjects?: boolean, cb?: Callback<Block>): Promise<Block>;
  public getWork(cb?: Callback<string[]>): Promise<string[]>;
  public givenProvider: Provider;
  public isMining(cb?: Callback<boolean>): Promise<boolean>;
  public isSyncing(cb?: Callback<boolean>): Promise<boolean>;
  public net: Net;
  public personal: Personal;
  public sendSignedTransaction(data: string, cb?: Callback<string>): PromiEvent<TransactionReceipt>;
  public sendTransaction(tx: Tx, cb?: Callback<string>): PromiEvent<TransactionReceipt>;
  public submitWork(nonce: string, powHash: string, digest: string, cb?: Callback<boolean>): Promise<boolean>;
  public sign(address: string, dataToSign: string, cb?: Callback<string>): Promise<string>;
...
export declare class Personal {
  public newAccount(password: string, cb?: Callback<boolean>): Promise<boolean>;
  public getAccounts(cb?: Callback<string[]>): Promise<string[]>;
  public importRawKey();
  public lockAccount();
